            ...
            <div class="row">
                ...
                ?>
                  ...
                  <div class="text-center">
								<h1 class="display-4 mt-2 text-danger">Retailer Order</h1>
					
								<h4 class="bg-danger text-light rounded p-2">Items Purchased : <?php echo $row['products']; ?></h4>
								<h4>Retailer Name :  <?php echo $row['name']; ?></h4>
								<h4>Retailer E-mail : <?php echo $row['email']; ?></h4>
								<h4>Retailer Phone : <?php echo $row['phone']; ?></h4>
								<h4>Total Amount Paid : RM<?php echo $row ['amount_paid']?> </h4>
                

								<h4>Payment Mode : <?php echo $row ['pmode']?> </h4>

                <form action="editStatusReceiptb.php" method="post" enctype="multipart/form-data">
                <h4>Status : <?php echo $row['paymentStatus']; ?></h4>
                            <input type="hidden" name="paymentID" value="<?php echo $row['paymentID'] ?>">
                  <select name="paymentStatus">
                    <option value="Accepted Receipt">Accepted Receipt</option>
                    <option value="Fake Receipt">Fake Receipt</option>
                    <option value="Rejected Receipt">Rejected Receipt</option>
                  </select> <br><br>
                  <input type="submit" value="Update" name="update" >
                </form>
							<br>
								<a  href="list-bulk-order.php"  Value=""> Back </a>
						  </div>
