            ...
            <div class="row">
                <div class="col-md-auto">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">List of Orders From Customer</h2>
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                      ...
                                      echo   "<td>" . '<a href="../customer/'.$row['uploadR'].'" download> Download</a>'. "</td>";
                                      echo "<td>". $row['paymentStatus'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="view-order-form.php?paymentID='. $row['paymentID'] .'" class="mr-3" title="View Order" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="edit-status-form.php?paymentID='. $row['paymentID'] .'" class="mr-3" title="Update Status" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
