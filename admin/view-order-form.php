            ...
            <div class="row">
                ...
                ?>
                  ...
                  <div class="text-center">
								<h1 class="display-4 mt-2 text-danger">Customer Order</h1>
					
								<h4 class="bg-danger text-light rounded p-2">Items Purchased : <?php echo $row['products']; ?></h4>
								<h4>Customer Name :  <?php echo $row['name']; ?></h4>
								<h4>Customer E-mail : <?php echo $row['email']; ?></h4>
								<h4>Customer Phone : <?php echo $row['phone']; ?></h4>
