...
$bulkItemID = $bulkItemName = $bulkItemGrade = $bulkItemPrice = $bulkItemQtty  = $bulkItemDesc  =  "";
$bulkItemID_err = $bulkItemName_err  = $bulkItemGrade_err  = $bulkItemPrice_err  = $bulkItemQtty_err   = $bulkItemDesc_err    = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_bulkItemGrade)){
        $bulkItemGrade_err = "Choose The Size.";     
    } else{
    ...
    if(empty($bulkItemID_err) && empty($bulkItemName_err) && empty($bulkItemGrade_err) && empty($bulkItemPrice_err) && empty($bulkItemQtty_err) && empty($bulkItemDesc_err)){
        // Prepare an insert statement
        $sql = "INSERT INTO bulkitem (bulkItemID, bulkItemName, bulkItemGrade, bulkItemPrice, bulkItemQtty, bulkItemDesc) 
        VALUES (?, ?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssis", $param_bulkItemID,  $param_bulkItemName , $param_bulkItemGrade, $param_bulkItemPrice , $param_bulkItemQtty
            , $param_bulkItemDesc);
