        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT  bulkItemID,bulkItemName,bulkItemGrade,bulkItemPrice,bulkItemQtty  from bulkitem";
                ...
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <div class="aa-footer-social">
                      ...
                      <a href="#"><span class="fa fa-Live"></span></a>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Copyright, Baling Thrift Store System</p>
