        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-center">
                  ...
                  $session =  $_SESSION['retailerEmail'] ;
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="view-bulkOrder-form.php?id='. $row['id'] .'" class="mr-3" title="View Order" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                            
                                            echo '<a href="delete-bulkOrder.php?id='. $row['id'] .'" title="Cancel Order" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
