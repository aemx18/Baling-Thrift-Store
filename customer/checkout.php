...
$sql = "SELECT CONCAT(itemName,'(',itemQtty,')') AS ItemQty, total_price, size FROM cartcust";
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 px-4 pb-4" id="order">
        ...
        <div class="jumbotron p-3 mb-2 text-center">
          ...
          <h6 class="lead"><b>Size: </b><?= $size;  ?></h6>
     ...
     <?php
        ...
        $currentRetailer = $_SESSION['custEmail'];
    $sql = "SELECT custName,custEmail,custPhone, custAddress FROM customer WHERE custEmail ='$currentRetailer'";
    $stmt = $link->prepare($sql);
    $stmt->execute();
    $result = $stmt->get_result();
    while ($row = $result->fetch_assoc()) {
  ...
  ?>
        ...
        <form action="" method="post" id="placeOrder">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="name" class="form-control" placeholder="Enter Name" value="<?php echo $row['custName']?>" >
          </div>
          <div class="form-group">
          <label>Customer Email:</label>
          <p><?php echo $row['custEmail']?></p>
            <input type="hidden" name="email" class="form-control" placeholder="Enter E-Mail" value="<?php echo $row['custEmail']?>" >
          
          </div>
          <div class="form-group">
          <label>Customer Phone:</label>
          <p><?php echo $row['custPhone']?></p>
            <input type="hidden" name="phone" class="form-control" placeholder="Enter Phone" value="<?php echo $row['custPhone']?>" >
          </div>
          <div class="form-group">
          <label>Customer Address:</label>
            <textarea type="hidden" name="address" class="form-control" rows="3" cols="10" placeholder="Enter Delivery Address Here..." ><?php echo $row['custAddress']?>"</textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <select name="pmode" class="form-control">
              ...
              <option value="Upload Receipt" required>Upload Receipt</option>
